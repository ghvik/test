...
def f06(string1, string2):
    ...
    if len(string1) >= len(string2):
        print("{} is longer than {} by {} chars"
            .format(string1, string2, len1 - len2))
    else:
        print("{} is longer than {} by {} chars"
            .format(string2, string1, len2 - len1))
...
###############################################################################
def f07(min_number, max_number):
    sum_ = 0
    while min_number <= max_number:
        if min_number % 3 == 0 or min_number % 5 == 0:
            sum_ += min_number
        min_number += 1
    return sum_

###############################################################################
def f08(min_number, max_number):
    sum_ = 0
...
###############################################################################
def f09(min_number, max_number):
    a = [x for x in range(min_number, max_number + 1) if x % 3 == 0 or x % 5 == 0]
    return sum(a)
...
def f12():
    floats = []
    while True:
        user_in = input("Please enter some input or 'done' to quit: ")
        if user_in == "done":
            break
        try:
